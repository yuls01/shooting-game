...
explosionSound = ['musics/explosion01.wav','musics/explosion02.wav','musics/explosion03.wav','musics/explosion04.wav']
...
def initGame():
    ...
    background = pygame.image.load('images/background.png') #배경그림
    fighter = pygame.image.load('images/fighter.png')#전투기 그림
    missile = pygame.image.load('images/missile.png') #미사일 그림
    explosion = pygame.image.load('images/explosion.png')#폭발그림
    pygame.mixer.music.load('musics/music.wav')
    pygame.mixer.music.play(-1)
    missileSound = pygame.mixer.Sound('musics/missile.wav')
    gameOverSound = pygame.mixer.Sound('musics/gameover.wav')
